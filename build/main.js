...
var la = require('./language');
var memory_1 = require('./memory');
var EvaluateTimeout = function () {
    function EvaluateTimeout(message) {
...
var Evaluator = function () {
    function Evaluator(program, input, timeout) {
        if (timeout === void 0) {
            timeout = 1000;
        }
        ...
        this.posStack = [];
        this.data = new memory_1.default();
        this.count = 0;
        this.pos = 0;
    ...
    Evaluator.prototype.step = function () {
        ...
        if (this.count > this.timeout) {
            throw new EvaluateTimeout('Timeout');
        }
        return res;
    };
    ...
    Evaluator.prototype.jumpForward = function () {
        if (this.data.get() === 0) {
            while (this.tok() !== 8) {
                this.pos++;
            }
    ...
    Evaluator.prototype.jumpBack = function () {
        this.pos = this.posStack.pop() - 1;
    };
    Evaluator.prototype.loadInput = function () {
        this.data.set(this.input.shift());
    };
    Evaluator.prototype.tok = function () {
        return this.program[this.pos];
    };
    Evaluator.prototype.endOfProgram = function () {
        return this.program.length <= this.pos;
    };
    return Evaluator;
}();
exports.default = Evaluator;
},{"./language":3,"./memory":4,"lodash":9}],2:[function(require,module,exports){
exports.default = {
    read: function (val) {
...
var _ = require('lodash');
var InvalidLanguage = function () {
    function InvalidLanguage(message) {
        this.message = message;
        this.name = 'InvalidLanguage';
    }
    return InvalidLanguage;
}();
exports.InvalidLanguage = InvalidLanguage;
function LanguageToArray(lang) {
    var res = [];
    _.forEach(lang, function (v) {
        res.push(v);
    });
    return res;
}
exports.LanguageToArray = LanguageToArray;
function LanguageValidate(lang) {
    var values = LanguageToArray(lang);
...
exports.LanguageValidate = LanguageValidate;
function LanguageToken(lang, str) {
    var l = lang;
    var res = undefined;
    _.forEach(l, function (v, key) {
        if (v === str) {
            switch (key) {
            case 'incPtr':
                res = 1;
...
var Memory = function () {
    function Memory() {
        this.pos = 0;
        var buf = new ArrayBuffer(30000);
        this.memory = new Uint8Array(buf);
        for (var i = 0; i < this.memory.length; ++i) {
            this.memory[i] = 0;
        }
    }
    Memory.prototype.incP = function () {
    ...
    Memory.prototype.decP = function () {
        if (this.pos === 0) {
    ...
    Memory.prototype.incB = function () {
        this.memory[this.pos]++;
    };
    Memory.prototype.decB = function () {
        this.memory[this.pos]--;
    };
    Memory.prototype.get = function () {
        return this.memory[this.pos];
    };
    Memory.prototype.set = function (b) {
...
var Parser = function () {
    ...
    Parser.prototype.parse = function (programStr) {
        var _this = this;
        var program = [];
        var lang = la.LanguageToArray(this.lang);
        var tok = '';
        for (var i = 0; i < programStr.length; ++i) {
            tok += programStr.charAt(i);
            var flagFinded = false;
            lang.forEach(function (w) {
                if (w === tok) {
                    program.push(la.LanguageToken(_this.lang, w));
                    tok = '';
                    flagFinded = true;
                    return false;
                }
            ...
            if (_.every(lang, function (l) {
                    return !_.startsWith(l, tok);
                })) {
                tok = '';
            }
        }
    ...
    Parser.prototype.checkParen = function (program) {
        var level = 0;
        program.forEach(function (tok) {
            switch (tok) {
            case 7:
                level++;
                break;
            case 8:
                if (level === 0) {
                    throw new ParseError('paren failed!!!');
                }
                level--;
                break;
            }
...
},{"./language":3,"lodash":9}],6:[function(require,module,exports){
...
},{"query-string":10}],7:[function(require,module,exports){
...
var MainVM = function (_super) {
    ...
    function MainVM(program, lang, input) {
        ...
        this._init({
            ...
            filters: { bytesFilter: bytes_1.default }
        });
        this.$watch('evaluator', function () {
            _this.evaluatorUpdated = true;
        });
    }
    MainVM.prototype.run = function () {
        ...
        try {
            if (this.isStep) {
                ...
                (_a = this.output).push.apply(_a, this.evaluator.eval());
            }
        } catch (e) {
    ...
    MainVM.prototype.updatePermalink = function () {
        var q = {
            program: this.program,
            lang: this.lang,
            input: this.input
        };
        var se = qs.Stringify(q).replace(/\./g, '%2E');
        var url = location.protocol + '//' + location.host + location.pathname + '?' + se;
        history.pushState(null, null, url);
    };
    MainVM.prototype.tweet = function () {
        this.updatePermalink();
        var lo = encodeURIComponent(location.href);
        var url = 'https://twitter.com/intent/tweet?hashtags=BrainfuckPlayground&original_referer=&tw_p=tweetbutton&url=' + lo;
        window.open(url);
    };
    MainVM.prototype.memory = function (idx) {
        var _ = this.count;
        return this.evaluator.data.memory[idx];
    };
    MainVM.prototype.isMemoryPos = function (pos) {
        var _ = this.count;
        return this.evaluator.data.pos === pos;
    };
    MainVM.prototype.toHex = function (n) {
    ...
    MainVM.prototype._tokens = function () {
        return this.parse();
    };
    MainVM.prototype._evaluator = function () {
        return new evaluator_1.default(this.tokens, this.input, this.timeout);
    };
    MainVM.prototype._parseError = function () {
        try {
            this.parse();
        } catch (e) {
    ...
    MainVM.prototype._invalidLangError = function () {
        try {
            la.LanguageValidate(this.lang);
        } catch (e) {
    ...
    MainVM.prototype._hasError = function () {
        return this.parseError !== '' || this.invalidLangError !== '';
    };
    MainVM.prototype.parse = function () {
        var c = new parser.Parser(this.lang);
        return c.parse(this.program);
    };
    return MainVM;
}(Vue);
exports.MainVM = MainVM;
var helloWorld = 'This program is hello world\n+++++++++[>++++++++>+++++++++++>+++++<<<-]>.>++.+++++++..+++.>-.\n------------.<++++++++.--------.+++.------.--------.>+.';
var q = qs.Parse();
var prog = q.program || helloWorld;
var vm = new MainVM(prog, q.lang, q.input);
console.log(vm);
},{"./evaluator":1,"./filters/bytes":2,"./language":3,"./parser":5,"./query_string":6,"vue":76}],8:[function(require,module,exports){
...
},{"../compiler":22,"../util":73,"_process":8}],18:[function(require,module,exports){
(function (process){
var _ = require('./util')
var config = require('./config')
...
},{"./config":24,"./util":73,"_process":8}],19:[function(require,module,exports){
/**
...
},{"../config":24,"../directives/prop":40,"../parsers/path":63,"../parsers/text":65,"../util":73,"_process":8}],21:[function(require,module,exports){
(function (process){
var _ = require('../util')
...
},{"../config":24,"../directives/component":29,"../parsers/directive":61,"../parsers/template":64,"../parsers/text":65,"../util":73,"./compile-props":20,"_process":8}],22:[function(require,module,exports){
var _ = require('../util')
...
},{"../config":24,"../parsers/template":64,"../util":73,"_process":8}],24:[function(require,module,exports){
module.exports = {
...
},{"../config":24,"../parsers/template":64,"../util":73,"_process":8}],30:[function(require,module,exports){
module.exports = {
...
},{"../cache":19,"../compiler":22,"../parsers/template":64,"../transition":66,"../util":73,"_process":8}],33:[function(require,module,exports){
...
},{"../../util":73,"./checkbox":34,"./radio":36,"./select":37,"./text":38,"_process":8}],36:[function(require,module,exports){
var _ = require('../../util')
...
},{"../../parsers/directive":61,"../../util":73,"../../watcher":77,"_process":8}],38:[function(require,module,exports){
var _ = require('../../util')
...
},{"../util":73,"_process":8}],40:[function(require,module,exports){
...
},{"../util":73,"_process":8}],42:[function(require,module,exports){
(function (process){
var _ = require('../util')
var config = require('../config')
...
},{"../compiler":22,"../config":24,"../parsers/expression":62,"../parsers/template":64,"../parsers/text":65,"../util":73,"_process":8}],43:[function(require,module,exports){
var transition = require('../transition')
...
},{"../cache":19,"../compiler":22,"../directives/if":32,"../parsers/template":64,"../parsers/text":65,"../util":73,"_process":8}],50:[function(require,module,exports){
var _ = require('../util')
var Path = require('../parsers/path')
...
},{"../util":73,"_process":8}],54:[function(require,module,exports){
...
},{"../util":73,"_process":8}],56:[function(require,module,exports){
(function (process){
var _ = require('../util')
var compiler = require('../compiler')
...
},{"../compiler":22,"../observer":59,"../observer/dep":58,"../util":73,"../watcher":77,"_process":8}],57:[function(require,module,exports){
var _ = require('../util')
var arrayProto = Array.prototype
...
},{"../cache":19,"../util":73,"./path":63,"_process":8}],63:[function(require,module,exports){
(function (process){
var _ = require('../util')
var Cache = require('../cache')
...
},{"../cache":19,"../util":73,"_process":8}],64:[function(require,module,exports){
var _ = require('../util')
var Cache = require('../cache')
...
},{"./index":73,"_process":8}],70:[function(require,module,exports){
(function (process){
/**
...
},{"../config":24,"_process":8}],71:[function(require,module,exports){
(function (process){
var _ = require('./index')
var config = require('../config')
...
},{"../config":24,"./index":73,"_process":8}],72:[function(require,module,exports){
...
},{"../config":24,"./index":73,"_process":8}],76:[function(require,module,exports){
var _ = require('./util')
var extend = _.extend
...
},{"./batcher":18,"./config":24,"./observer/dep":58,"./parsers/expression":62,"./util":73,"_process":8}]},{},[1,2,3,4,5,6,7]);
